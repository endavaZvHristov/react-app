...
function generate(paths) {
    ...
    writeFile(paths.output, 'module.exports = ' + JSON.stringify(errors.lenght ? errors : componentData));
}
...
function writeFile(filepath, content) {
    return fs.writeFile(filepath, content, (error) => {
        return error ? console.log(chalk.red(error)) : console.log(chalk.green('Component data saved'));
    });
}
